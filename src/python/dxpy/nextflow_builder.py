...
@dxpy.entry_point('test')
def test(test_parameter):
    print(glob.glob("/home/dnanexus/*"))
    print(test_parameter)
    # output = {"fids":{"$dnanexus_link": "file-G618yx00k25g384X3j4QzKq9"}}
    return {'output_file': {"$dnanexus_link": "file-G618yx00k25g384X3j4QzKq9"}}
...
def main(**job_inputs):
    ...
    #         break
    outfile = open('/home/dnanexus/test-file.out', 'w')
    outfile.write("fffff")
    outfile.close()

    print(glob.glob("/home/dnanexus/*"))
    read_names = dxpy.new_dxjob({'test_parameter': "test_parameter!!"}, 'test')
    # output = {"fids":{"$dnanexus_link": "file-G618yx00k25g384X3j4QzKq9"}}
    return {'output_file': read_names.get_output_ref('output_file')}
